...
const Partners = () => {
  ...
  const links = {
    ...
    deliveroo: 'https://deliveroo.fr/fr/menu/Saint-Malo/saint-malo-centre-ville/chapati-indian-street-food',
    ...
    <section className="partners">
      <div className="container">
        ...
        <div className="partners-grid">
          ...
          <a href={links.deliveroo} target="_blank" rel="noreferrer" aria-label="Deliveroo">
            <img src="https://upload.wikimedia.org/wikipedia/commons/9/94/Deliveroo_Logo.svg" alt="Deliveroo" className="partner-logo deliveroo" />
          </a>
